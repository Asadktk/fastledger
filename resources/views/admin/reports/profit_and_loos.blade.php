                ...
                <div class="col-xl-12">
                    <div class="card custom-card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title">Profit And Loos Report</h4>
                        </div>
                        <div class="card-body">
                            <!-- Report Filters -->
                            ...
                            <div class="table-responsive">
                                ...
                                <table>
                                    <tr>
                                        <td colspan="3" class="section-title">Profit and Loss Report</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <!-- Income -->
                                    <tr>
                                        <td colspan="3" class="section-title">Income</td>
                                    </tr>
                                    ...
                                    <!-- Cost of Sales -->
                                    <tr>
                                        <td colspan="3" class="section-title">Cost of Sales</td>
                                    </tr>
                                    ...
                                    <!-- Expenses -->
                                    <tr>
                                        <td colspan="3" class="section-title">Expenses</td>
                                    </tr>
