...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('user', function (Blueprint $table) {
            $table->integer('User_ID', true)->comment('fUserID identifies tbAdminUser');
            $table->string('Full_Name', 50)->nullable()->comment('fFullName is of tbAdminUser');
            $table->string('User_Name', 50)->nullable()->comment('fUserName is of tbAdminUser');
            $table->string('password', 250)->nullable()->comment('fPassword is of tbAdminUser');
